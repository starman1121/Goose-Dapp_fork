      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{textAlign: 'right', height: '20px'}}>
            <a
              href="https://twitter.com/goose_finance"
            ...
            <a href="https://discord.gg/CPMBSHVB" rel="noopener noreferrer" target="_blank" className={classes.link}>
              <IconDiscord style={{fill: '#dddfee', height: '20px'}} />
            </a>

            <a href="https://github.com/GooseFinan" rel="noopener noreferrer" target="_blank" className={classes.link}>
