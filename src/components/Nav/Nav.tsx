...
import bombLogo from '../../assets/img/goose-logo.png';
...
const Nav = () => {
  ...
  // console.log('debug bombStates', bombStats)
          ...
          <>
            ...
            <Typography variant="h6" color="inherit" noWrap style={{flexGrow: '0'}} className={classes.toolbarTitle}>
              ...
              <Link to="/" color="inherit" className={classes.brandLink}>
                <img alt="goosefinance.xyz" src={bombLogo} height="60px" />
              </Link>
            </Typography>
            <Box style={{paddingLeft: '15px', paddingTop: '10px', fontSize: '1rem', flexGrow: '1'}}>
              ...
              <a href="https://crypto-business.gitbook.io/goosefinance/" className={'navLink ' + classes.link} rel="noopener noreferrer" target="_blank">
                Docs
              </a>
              ...
              <List>
                ...
                <ListItemLink primary="Home" to="/" />
                  <ListItemLink primary="Farm" to="/farm" />
                       <ListItemLink primary="xEGG" to="/xbul" />
                ...
                <ListItem button component="a" href="https://crypto-business.gitbook.io/goosefinance/">
