...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.ESHARE, bombFinance.contracts.Boardroom.address);

  const tokenBalance = useTokenBalance(bombFinance.ESHARE);
  const stakedBalance = useStakedBalanceOnBoardroom();
  const {from, to} = useUnstakeTimerBoardroom();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('ESHARE', bombFinance.ESHARE);
