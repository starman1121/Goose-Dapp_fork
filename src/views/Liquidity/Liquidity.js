...
const ProvideLiquidity = () => {
  ...
  const bombFtmLpStats = useLpStats('EGG-BTCB-LP');
  ...
  const handleBulChange = async (e) => {
    ...
    setBulAmount(e.currentTarget.value);
    const quoteFromSpooky = await bombFinance.quoteFromSpooky(e.currentTarget.value, 'EGG');
  ...
  const handleBulSelectMax = async () => {
    const quoteFromSpooky = await bombFinance.quoteFromSpooky(getDisplayBalance(bombBalance), 'EGG');
        ...
        <Box style={{ width: '600px' }}>
          <Alert variant="filled" severity="warning" style={{ marginBottom: '10px' }}>
            <b>
              ...
              are the only ways to provide Liquidity on EGG-BTCB pair without paying tax.
            </b>
          </Alert>
                ...
                <Grid item xs={12} sm={12} style={{ borderRadius: 15 }}>
                  <Box p={4}>
                    <Grid container>
                      ...
                      <Grid item xs={12}>
                        <p>1 EGG = {bombPriceInBNB} BNB</p>
                        <p>1 BNB = {ftmPriceInBUL} EGG</p>
