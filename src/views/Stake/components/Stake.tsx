...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(bombFinance.EGG, bombFinance.contracts.xEGG.address);

  const tokenBalance = useTokenBalance(bombFinance.EGG);
  ...
  const stakedTokenPriceInDollars = Number(useStakedTokenPriceInDollars('EGG', bombFinance.EGG)) * xbulRate;
        ...
        <CardContent>
          ...
          <StyledCardContentInner>
            <StyledCardHeader>
              ...
              <Label text={'xEGG Balance'} variant="yellow" />
            </StyledCardHeader>
            <StyledCardActions>
